...
public class helpFile {
	...
	public static final String text = "<html><h3>MagicCarbon (Model of Global AtmospherIc Carbon)</h3>" +
	"<p>MagicCarbon is a simple carbon budget simulator" +
	...
	"<ul>" +
	"<li>Simple airborne fraction model - " +
	...
	"Catm[t+1] = Catm[t] + Cemitted[t] * 0.43. </li>" +			
	"<li>Mass balance model - Mass balance model for atmospheric carbon. " +
	"delta C = [ S - (C0 / tau) ] delta t, where residence time of atmopheric" +
	" carbon, tau is set to 200 years (2).</li>" +
	"<li>Box model - This is the classic 1D carbon box model with fluxes " +
	"between the sources and sinks. This version has four boxes: " +
	"atmosphere, terrestrial biosphere, ocean and deep ocean (3).</li>" +
	"<li>Impulse Response function - " +
	"A simple carbon budget model that uses impulse response " +
	"function (IRF) based on (4) and (5).</li>" +
	"</ul>" +
	"<h4>Datasets and Model testing</h4>" +
	...
	"<ul>" +
	"<li>A1 - Rapid economic growth, population peaks 2050, introduction of efficient technologies</li> " +
	"<li>A2 - Continuously growing population, slow introduction of efficient technologies</li> " +
	"<li>B1 - Population peaks 2050, rapid adoption of efficient technologies</li> " +
	"<li>B2 - Continuously growing population, regional development</li>" +
	"</ul>" +
	"<h4>Running the model</h4>" +
	"<ul><li>Selecting simulation:</li><ul>" +
	"<li>Test against obsevations over the period (1959-2008)</li>" +
	"<li>Fixed emission can be run over any period</li>" +
	"<li>Runs using the IPCC scenarios over the period (1990-2100)</li>" +
	"</ul>" +
	"<li>Model - " +
	"One of the four models discussed above can be run.</li>" +
	"<li>IPCC SRES - " +
	"One of 6 scenarios can be run.  There are 3 A1 scenarios, and 1 " +
	"scenario from each of the other 3 families.</li>" +
	"<li>Fixed emissions - " +
	"Fixed emissions scenarios allow the greates flexibility and any period can be selected.</li>" +
	"<li>Outputs - Plots and datasets are output.  A summary of the output is also given.</li>" +
	"</ul>" +
	"<h4>References</h4><ol>" +
	"<li>LeQuere (2009) Nature Geosciences</li>" +
	"<li>Mackay et al http://www.atmosedu.com/physlets/GlobalPollution/CO2assign.htm</li>" +
	"<li>Rodhe (1979) Tellus </li>" +
	"<li>Boucher et al, (2008) Climatic Change</li>" +
	"<li>Joos and Bruno (1997) Phys. and Chem. of the Earth</li>" +
	"<li>http://co2now.org/Current-CO2/CO2-Now/noaa-mauna-loa-co2-data.html</li>" +
	"<li>http://co2now.org</li>" +
	"<li>http://sres.ciesin.org/final_data.html</li><ol><html>";
